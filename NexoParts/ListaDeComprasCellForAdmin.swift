//
//  ListaDeComprasCellForAdmin.swift
//  NexoParts
//
...
class ListaDeComprasCellForAdmin: UITableViewCell {
    ...
    func showNumberLabel(){
        ...
        numberLabel.widthAnchor.constraint(equalTo: self.widthAnchor, multiplier: 0.35).isActive = true
    }
    func showIdCardIcon(){
    ...
    func showUsernameLabel(){
        ...
        userNameLabel.widthAnchor.constraint(equalTo: self.widthAnchor, multiplier: 0.35).isActive = true
    ...
    func showArticleTitle(){
        ...
        articleTitleLabel.centerYAnchor.constraint(equalTo: userNameLabel.centerYAnchor).isActive = true
        articleTitleLabel.rightAnchor.constraint(equalTo: self.rightAnchor, constant: -15).isActive = true
        articleTitleLabel.widthAnchor.constraint(equalTo: self.widthAnchor, multiplier: 0.50).isActive = true
    }
