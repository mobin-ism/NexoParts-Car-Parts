//
//  AddedToMisComprasAlertViewController.swift
//  NexoParts
//
//  Created by Creativeitem on 7/16/17.
//  Copyright © 2017 Creativeitem. All rights reserved.
//

import UIKit
class AddedToMisComprasAlertViewController: UIViewController {
    ...
    let alertMessage: UILabel = {
        let label = UILabel()
        label.textAlignment = .center
        label.text = "Los Articulos seleccionados se agregaron a tu lista de compras"
